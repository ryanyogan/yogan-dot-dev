<div className="p-10">
  ...
  <div className="prose">
    ...
    <h2 className="text-lg font-bold mt-10">Okay, that's all well and good, and the "Incredible Thoughts?"</h2>
    <div className="leading-8">
      I love the movie "Popstar: Never Stop Never Stopping" and this video with the
      one and only Michael Bolton is pure gold:
    </div>
